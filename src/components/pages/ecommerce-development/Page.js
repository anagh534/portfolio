    ...
    return (
        <ServicePageTemplate
            ...
            faqs={[
                ...
                { question: "Can you build a multi-vendor marketplace?", answer: "Yes. I build multi-vendor marketplace platforms where multiple sellers can register, list products, and manage their own storefront — similar to Amazon or Flipkart but for your ." },
