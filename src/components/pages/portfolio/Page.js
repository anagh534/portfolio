    ...
    return (
        <div className="min-h-screen bg-black overflow-hidden relative pt-28 sm:pt-32 pb-24">
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                    ...
                    {categories.map((category) => {
                        ...
                        return (
                            <button
                                ...
                                className={`px-4 py-2 sm:px-5 sm:py-2.5 rounded-2xl text-xs sm:text-sm font-bold transition-all duration-200 active:scale-95 ${
                                    isSelected
                ...
                {/* Projects Grid with Instant Rendering */}
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-20">
                    {filteredProjects.map((project) => (
                        <div
                            key={project.id}
                            className="group rounded-[32px] bg-white/[0.03] border border-white/10 hover:border-blue-500/40 backdrop-blur-xl overflow-hidden transition-all duration-300 flex flex-col justify-between shadow-xl hover:shadow-2xl hover:shadow-blue-500/10 hover:-translate-y-1.5"
                        >
                            {/* Thumbnail Frame */}
                ...
                {/* Bottom CTA Box */}
                <div className="p-8 sm:p-12 rounded-[36px] bg-gradient-to-b from-white/[0.05] to-white/[0.02] border border-white/10 backdrop-blur-xl text-center max-w-4xl mx-auto">
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-4">
                        <a
                            ...
                            className="inline-flex items-center gap-2.5 px-8 py-4 rounded-2xl bg-blue-600 hover:bg-blue-500 text-white font-bold text-sm uppercase tracking-wider transition-all duration-200 active:scale-95 shadow-xl shadow-blue-500/25"
                        >
                        ...
                        <a
                            href="/contact/"
                            className="inline-flex items-center gap-2.5 px-8 py-4 rounded-2xl bg-white/5 hover:bg-white/10 border border-white/10 text-white font-bold text-sm uppercase tracking-wider transition-all duration-200 active:scale-95"
                        >
