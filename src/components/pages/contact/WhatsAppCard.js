...
export default function WhatsAppCard() {
    return (
        <div
            ...
            onClick={() => window.open('https://wa.me/918281571805?text=Hello%2C%20I%20am%20interested%20in%20your%20services', '_blank')}
        >
            ...
            <div className="space-y-1">
                ...
                <p className="text-gray-400 text-sm group-hover:text-emerald-400 transition-colors">+91 8281571805</p>
