    ...
    return (
        <section className="relative py-14 sm:py-20 md:py-24 overflow-hidden" id="works">
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                {/* Section Header with integrated 'View All Works' button - glides in from TOP via GSAP */}
                <div
                ...
                {/* Projects Grid: exactly 4 items in 1 single row on laptop/desktop with GSAP stagger */}
                <div
