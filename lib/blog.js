...
export async function getBlogPosts() {
    ...
    try {
        ...
        // For Static Export (output: 'export'), we want this to run at BUILD TIME.
        // We force-cache to ensure Next.js treats this as a static data dependency.
        const res = await fetch(GOOGLE_SHEET_URL, { cache: 'force-cache' });
